...
class AttendanceRecord(models.Model):
    ...
    short_code = models.CharField(unique=True, blank=False, max_length=3,
                                  help_text="Short code of this attendance record, for digest viewing")
    description = models.CharField(unique=True, blank=False, max_length=settings.DEFAULT_MAX_CHARFIELD_LENGTH,
